...
const mockGetDatabaseHealth = getDatabaseHealth as jest.MockedFunction<
  typeof getDatabaseHealth
>;
const mockGetRedisHealth = getRedisHealth as jest.MockedFunction<
  typeof getRedisHealth
>;
...
describe("MetricsService", () => {
  ...
  describe("collectHttpMetrics", () => {
    ...
    it("should handle requests without route path", () => {
      ...
      expect(() =>
        MetricsService.collectHttpMetrics(mockReq, mockRes, 100),
      ).not.toThrow();
    });
  });
  ...
  describe("collectDatabaseMetrics", () => {
    ...
    it("should handle missing table parameter", () => {
      ...
      expect(() =>
        MetricsService.collectDatabaseMetrics(queryTime, operation),
      ).not.toThrow();
    });
  });
  ...
  describe("collectUserOperationMetrics", () => {
    it("should collect user operation metrics with role", () => {
      ...
      expect(() =>
        MetricsService.collectUserOperationMetrics(operation, userRole),
      ).not.toThrow();
    });
    ...
    it("should handle missing user role", () => {
      ...
      expect(() =>
        MetricsService.collectUserOperationMetrics(operation),
      ).not.toThrow();
    });
  });
  ...
  describe("collectAuditMetrics", () => {
    it("should collect audit metrics with correct parameters", () => {
      ...
      expect(() =>
        MetricsService.collectAuditMetrics(riskLevel, tableName),
      ).not.toThrow();
    });
  });
  ...
  describe("collectRedisMetrics", () => {
    it("should collect Redis operation metrics", () => {
      expect(() =>
        MetricsService.collectRedisMetrics("GET", "hit"),
      ).not.toThrow();
      expect(() =>
        MetricsService.collectRedisMetrics("SET", "success"),
      ).not.toThrow();
      expect(() =>
        MetricsService.collectRedisMetrics("GET", "miss"),
      ).not.toThrow();
    });
  });
  ...
  describe("updateRedisMetrics", () => {
    ...
    it("should handle Redis health check errors", async () => {
      mockGetRedisHealth.mockRejectedValue(
