 ...
 */
export const checkTestDatabaseHealth = async (dataSource: DataSource): Promise<boolean> => {
  try {
    ...
    const hasPgCrypto = extensions.some((ext: { extname: string }) => ext.extname === 'pgcrypto');
