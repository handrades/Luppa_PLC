...
export class AddImportHistoryTable1755714547339 implements MigrationInterface {
  name = "AddImportHistoryTable1755714547339";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "roles" ADD "permissions" jsonb NOT NULL DEFAULT '{}'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sites" DROP CONSTRAINT "FK_924cbb76316cb81be8f40927082"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sites" DROP CONSTRAINT "FK_e2a9a2377348da2183f26b38fa1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cells" DROP CONSTRAINT "FK_1d1a90a47be7942250759e3af05"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cells" DROP CONSTRAINT "FK_ffe2c573a2a23ad507b3ff27084"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cells" DROP CONSTRAINT "FK_8dd6e4da28e2a2b71c3ea5e8ea3"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "plcs" DROP CONSTRAINT "FK_e15f927e2bf857af5fc3899363b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "plcs" DROP CONSTRAINT "FK_637b0ca84526be30651042912e9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "plcs" DROP CONSTRAINT "FK_4a03891dfcbcf54b8b311c5c569"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tags" DROP CONSTRAINT "FK_f670cc12e5c02adf1b4c86ee3e0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tags" DROP CONSTRAINT "FK_32f027a90ce9c91c9b8ff830d22"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tags" DROP CONSTRAINT "FK_59f9e4a563370c700df66e956ac"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_a2cecd1a3531c0b041e29ba46e1"`,
    );
    await queryRunner.query(
      `DROP INDEX "core"."IDX_97672ac88f789774dd47f7c8be"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "roles" ADD "is_system_role" boolean DEFAULT false`,
    );
    await queryRunner.query(
      `DROP INDEX "core"."IDX_45575c290a2b47aa366e853d07"`,
    );
    await queryRunner.query(
      `DROP INDEX "core"."IDX_4bbe32b3f6fca66f54509fe57e"`,
    );
    await queryRunner.query(
      `DROP INDEX "core"."IDX_88dcc148d532384790ab874c3d"`,
    );
    await queryRunner.query(
      `DROP INDEX "core"."IDX_cee5459245f652b75eb2759b4c"`,
    );
    await queryRunner.query(
      `DROP INDEX "core"."IDX_ddc1431fb26a7b342e84e498f8"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "core"."IDX_7a7dbd4513de54a315d97e1a7d"`,
    );
    await queryRunner.query(`DROP TABLE "sites"`);
    await queryRunner.query(
      `DROP INDEX "core"."IDX_bd9a7457cfaaff0fe8fd5956de"`,
    );
    await queryRunner.query(`DROP TABLE "cells"`);
    await queryRunner.query(`DROP TABLE "equipment"`);
    await queryRunner.query(`DROP TYPE "core"."equipment_equipment_type_enum"`);
    await queryRunner.query(
      `DROP INDEX "core"."IDX_b3993f607ad48095c2e3db3958"`,
    );
    await queryRunner.query(
      `DROP INDEX "core"."IDX_e537f8f18e965dc370e3b33345"`,
    );
    await queryRunner.query(
      `DROP INDEX "core"."IDX_d88f7fdeaa85935fbccc6aade5"`,
    );
    await queryRunner.query(`DROP TABLE "plcs"`);
    await queryRunner.query(
      `DROP INDEX "core"."IDX_d8cef3790946b71d36f4cb19ac"`,
    );
