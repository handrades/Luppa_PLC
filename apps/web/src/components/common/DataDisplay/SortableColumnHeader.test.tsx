...
describe('SortableColumnHeader', () => {
  describe('Rendering', () => {
    ...
    it('should show ascending icon when sorted asc', () => {
      const sortState: SortState[] = [{ columnId: 'test', direction: 'asc', priority: 0 }];
    ...
    it('should show descending icon when sorted desc', () => {
      const sortState: SortState[] = [{ columnId: 'test', direction: 'desc', priority: 0 }];
      const { container } = renderHeader({ sortState });
  ...
  describe('sortData function', () => {
    ...
    it('should sort data in ascending order', () => {
      const sortState: SortState[] = [{ columnId: 'name', direction: 'asc', priority: 0 }];
    ...
    it('should sort data in descending order', () => {
      const sortState: SortState[] = [{ columnId: 'value', direction: 'desc', priority: 0 }];
    ...
    it('should use custom getValue function', () => {
      ...
      const sortState: SortState[] = [{ columnId: 'userName', direction: 'asc', priority: 0 }];
  ...
  describe('updateSortState function', () => {
    ...
    it('should replace existing sort in single column mode', () => {
      const currentState: SortState[] = [{ columnId: 'col1', direction: 'asc', priority: 0 }];
