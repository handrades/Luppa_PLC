...
describe('DataGrid', () => {
  describe('Basic Rendering', () => {
    it('should render the grid with headers', () => {
      renderDataGrid();
  ...
  describe('Sorting Functionality', () => {
    ...
    it('should support multi-column sorting with shift key', async () => {
      ...
      fireEvent.click(
        nameHeader.closest('[class*="HeaderContainer"]') || nameHeader,
        { shiftKey: true }
      );
      ...
      await waitFor(() => {
        ...
        expect(nameHeader.parentElement?.querySelector('[data-testid*="Arrow"]')).toBeInTheDocument();
      });
    });
    ...
    it('should maintain sort state when data changes', async () => {
      ...
      const { rerender } = renderDataGrid({ data: initialData, sortable: true });
    ...
    it('should respect column sortable property', async () => {
      ...
      const onSortChange = jest.fn();
      renderDataGrid({ columns: columnsWithNonSortable, sortable: true, onSortChange });
