      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <p style={{ margin: 0, color: '#666' }}>
            This shows how the header appears in context with application content.
            The header maintains its position and provides consistent navigation.
          </p>
        </div>
        <div style={{ 
          backgroundColor: 'white', 
          ...
          <h3 style={{ margin: 0, marginBottom: '1rem', color: '#1976d2' }}>
            Equipment Overview
          </h3>
          <p style={{ margin: 0, color: '#666' }}>
            Sample content area showing industrial application layout with the header.
            Users can access menu and profile options from any page.
          </p>
        </div>
      </div>
    </div>
