...
Components follow this structure [Source: architecture/frontend-architecture.md#Component Organization]:
...
- **Coverage requirements**: All new components have corresponding test files
