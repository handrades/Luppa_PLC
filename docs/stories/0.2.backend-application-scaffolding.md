...
- **Backend Framework**: Express 5.1.0 - Latest LTS with improved security and Node 18+ support
...
- **Testing**: Jest 30.0 - API and unit testing consistent with frontend testing
